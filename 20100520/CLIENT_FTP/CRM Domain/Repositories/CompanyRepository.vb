Public Class CompanyRepository
    ...
    Public Shared Function GetByUser(ByVal Id As Integer) As List(Of Company)
        ...
        Try
            ...
            If tb Is Nothing Then
                MsgBox("No se encontraron empresas relacionadas al usuario activo", MsgBoxStyle.Critical)
                Return List
            End If
    ...
    Public Shared Function Validate(ByVal Entity As Company) As Boolean
        ...
        Try
            ...
            Query = QueryHandler.FormatQuery(QueryHandler.GetQuery("DbValidation"), New QueryHandler.Parameter() {New QueryHandler.Parameter("<database>", Entity.Database), New QueryHandler.Parameter("<ownerdatabase>", SystemCompany.Database)})
