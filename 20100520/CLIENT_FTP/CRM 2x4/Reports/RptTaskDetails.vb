...
Public Class RptTaskDetails
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Crm.UI.RptTaskDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptTaskDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptTaskDetails = New RptTaskDetails
        rpt.Site = Me.Site
        Return rpt
    End Function
