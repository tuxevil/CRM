Public Class frmException
    ...
    Public Sub ShowException(ByVal ex As Exception, Optional ByVal Dialog As Boolean = False, Optional ByVal SendMessage As Boolean = True)
        Try
            txtMessage.Text = ex.Message
            txtDetail.Text = ex.ToString

            Me.cmdSendError.Visible = SendMessage
