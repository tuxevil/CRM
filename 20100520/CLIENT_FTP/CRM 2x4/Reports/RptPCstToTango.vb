...
Public Class RptPCstToTango
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Crm.UI.RptPCstToTango.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptPCstToTango
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptPCstToTango = New RptPCstToTango
        rpt.Site = Me.Site
        Return rpt
    End Function
