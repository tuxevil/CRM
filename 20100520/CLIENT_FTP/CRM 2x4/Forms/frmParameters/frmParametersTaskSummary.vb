Public Class frmParametersTaskSummary
    ...
    Private Sub ShowReport()
        ...
        Try
            ...
            dt = Domain.ReportRepository.TaskList(txtUserFrom.Text, txtUserTo.Text, DateFrom.Value, DateTo.Value, txtTypeFrom.Text, txtTypeTo.Text, txtStateFrom.Text, txtStateTo.Text)
