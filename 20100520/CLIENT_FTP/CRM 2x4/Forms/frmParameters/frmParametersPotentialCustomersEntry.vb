Public Class frmParametersPotentialCustomersEntry
    ...
    Private Sub ShowReport()
        ...
        Try
            ...
            dt = Domain.ReportRepository.PotentialCustomersEntry(txtUserFrom.Text, txtUserTo.Text, DateFrom.Value, DateTo.Value, txtCustomerFrom.Text, txtCustomerTo.Text)

            Rpt = New RptPCstEntry
