Public Class QueryHandler
    ...
    Public Shared Function FormatQuery(ByVal Query As String, ByVal ParamArray Parameters() As Parameter) As String
        ...
        Try
            ...
            'MsgBox("Formating parameters:" & vbNewLine & Query, MsgBoxStyle.Information)
            Return Query
    ...
    Public Shared Function GetQuery(ByVal Code As String) As String
        ...
        Try
            ...
            'MsgBox(QString, MsgBoxStyle.Information)
            ' MsgBox(Encrypter.DecryptString(Database.GetData(QString).Rows(0).Item("STRING")), MsgBoxStyle.Information)
            Return sResult
