...
Public Class RptPCstDeleted
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Crm.UI.RptPCstDeleted.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptPCstDeleted
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptPCstDeleted = New RptPCstDeleted
        rpt.Site = Me.Site
        Return rpt
    End Function
