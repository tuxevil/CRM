Public Class ProfileRepository
    ...
    Public Shared Function GetByUser(ByVal User As Integer, ByVal company As Integer) As Profile

        Try

            Query = QueryHandler.FormatQuery(QueryHandler.GetQuery("PflByUser"), New QueryHandler.Parameter() {New QueryHandler.Parameter("<ownerdatabase>", SystemCompany.Database), New QueryHandler.Parameter("<user>", User), New QueryHandler.Parameter("<company>", company)})
    ...
    Public Shared Function FullUser(ByVal companyID As Integer, ByVal UserId As Integer, ByVal ProfileId As Integer) As Boolean
        Try
            ...
            'MsgBox(Database.GetData(Query).Rows(0).Item(0))
