Public Class frmParametersTaskDetails
    ...
    Private Sub ShowReport()
        ...
        Try
            ...
            dt = Domain.ReportRepository.TaskDetails(txtUserFrom.Text, txtUserTo.Text, DateFrom.Value, DateTo.Value, txtTypeFrom.Text, txtTypeTo.Text, txtStateFrom.Text, txtStateTo.Text)

            Rpt = New RptTaskDetails
    ...
    Private Sub EnableForm(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuReportListByUser.Click, MenuReportListByType.Click, MenuReportListByStatus.Click, MenuReportListByDate.Click
